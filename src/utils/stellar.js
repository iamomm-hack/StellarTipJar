 ...
 */
export async function buildPaymentTransaction(senderPublicKey, destinationAddress, amount) {
  try {
    // Load sender account
  ...
  try {
    ...
    if (error.response && error.response.data) {
      ...
      if (extras && extras.result_codes) {
        throw new Error('Transaction failed: ' + JSON.stringify(extras.result_codes));
      }
    }
